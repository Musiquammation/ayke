...
import { GMStars } from "../../commons/gamemods/GMStars";
...
const logger = getLogger('bots-stars');
// logger.setLevel('debug');

const {all, first, loop, runner} = botActionNodeHelper<GMStars, Data>();

const TYPES = GMStars.types;
